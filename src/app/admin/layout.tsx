    ...
    <div className="min-h-screen bg-gogrow-gray-light flex">
      ...
      <aside className="w-64 bg-gogrow-black text-white flex-shrink-0 flex flex-col fixed h-full z-10 transition-transform">
        <div className="p-6 border-b border-white/10 shrink-0">
          ...
          <p className="text-xs text-gray-400 mt-1 uppercase tracking-wider">Painel Admin</p>
        </div>
        ...
        <nav className="flex-1 py-6 px-4 space-y-2 overflow-y-auto">
          ...
          >
            ...
            <span className="font-medium">Dashboard Usuário</span>
          </Link>
          
          <Link
            href="/admin"
            className="flex items-center gap-3 px-4 py-3 rounded-lg bg-gogrow-red/10 text-gogrow-red transition-colors font-medium border border-gogrow-red/20"
          >
            <Settings size={20} />
      ...
      <main className="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <header className="h-16 bg-white border-b flex items-center px-8 shadow-sm shrink-0 sticky top-0 z-10">
          <h1 className="text-xl font-bold text-gogrow-black flex items-center gap-2">
            <Settings className="text-gogrow-red" size={24} /> 
